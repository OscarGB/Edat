...
#$COMMAND query libreria_db <<EOF
#usuarios SEQUENTIAL 1 STR jack C_COLEQCTE SELECT LNG 0 P_COL 1 PROJECT
#EOF

#$COMMAND query libreria_db <<EOF
#usuarios SEQUENTIAL 1 STR jack C_COLEQCTE SELECT LNG 0 P_COL 1 PROJECT ventas SEQUENTIAL PRODUCT 0 2 C_COLEQCOL SELECT LNG 0 P_COL STR 3 P_COL 2 PROJECT
#EOF

#$COMMAND query libreria_db <<EOF
#usuarios SEQUENTIAL 1 STR jack C_COLEQCTE SELECT LNG 0 P_COL 1 PROJECT ventas SEQUENTIAL PRODUCT 0 2 C_COLEQCOL SELECT LNG 0 P_COL STR 3 P_COL 2 PROJECT libros SEQUENTIAL PRODUCT
#EOF

#$COMMAND query libreria_db <<EOF
#usuarios SEQUENTIAL 1 STR jack C_COLEQCTE SELECT LNG 0 P_COL 1 PROJECT ventas SEQUENTIAL PRODUCT 0 2 C_COLEQCOL SELECT LNG 0 P_COL STR 3 P_COL 2 PROJECT libros SEQUENTIAL PRODUCT 1 9 C_COLEQCOL SELECT
#EOF
